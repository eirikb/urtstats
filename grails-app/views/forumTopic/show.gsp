                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:forumTopicInstance, field:'id')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:forumTopicInstance, field:'name')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="forumGenre" action="show" id="${forumTopicInstance?.genre?.id}">${forumTopicInstance?.genre?.encodeAsHTML()}</g:link></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="jsecUser" action="show" id="${forumTopicInstance?.user?.id}">${forumTopicInstance?.user?.encodeAsHTML()}</g:link></td>
