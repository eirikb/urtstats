<html>
  ...
  <body>
    ...
    <p>The project is split up in mainly three parts, the setup (hosting, email), this page and the parser (parsing game log files).</p>
    <ul>
      <li>
        <p><b>Hosting:</b></p>
      ...
      <li>
        ...
        <p>it's interesting, can adopt many components and rapidly fills up the database.</p>
      </li>
      <li>
        <p><b>Parser:</b></p>
    ...
    <p>Project activity can be found <a href="${resource(base:'http://eirikb.no/redmine/projects/activity/urtstats')}" target="_blank">HERE</a>.</p>
    <ul>
      <li>
      ...
      <li>
        ...
        <p>The parser is now split into many different classes for each "event".</p>
        <p>Written a complete set of Unit Tests - one for each Event +++.</p>
      </li>
      <li>
        <p><b>0.2:</b></p>
